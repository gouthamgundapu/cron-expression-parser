...
public class Values extends org.deliveroo.cronexpressionparser.selectors.Base {
    ...
    public Values(org.deliveroo.cronexpressionparser.fields.Base field) {
        super(field);
    }
    ...
    public java.util.List<Integer> generatePossibilities() {
        ...
        return java.util.List.of(lists).stream()
                .flatMap(l -> {
                    try {
                        return org.deliveroo.cronexpressionparser.selectors.Base.get(new org.deliveroo.cronexpressionparser.fields.Base(l) {
                            @Override
